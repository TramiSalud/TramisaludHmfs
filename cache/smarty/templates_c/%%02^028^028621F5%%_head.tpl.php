<?php /* Smarty version 2.6.11, created on 2022-07-05 19:53:59
...
'></script>
<!--se agregan librerias de notificaciones-->
    <link href='<?php echo smarty_function_sugar_getjspath(array('file' => "themes/Sugar5/css/pnotify.custom.min.css"), $this);?>
' media="all" rel="stylesheet" type="text/css">
    <script type="text/javascript" src='<?php echo smarty_function_sugar_getjspath(array('file' => "themes/Sugar5/js/pnotify.custom.min.js"), $this);?>
'></script>
    <script type="text/javascript" src='<?php echo smarty_function_sugar_getjspath(array('file' => "themes/Sugar5/js/notify.js"), $this);?>
'></script>
</head>