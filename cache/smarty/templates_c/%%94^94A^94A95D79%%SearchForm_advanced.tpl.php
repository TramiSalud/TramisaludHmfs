<?php /* Smarty version 2.6.11, created on 2022-07-06 22:11:13
         compiled from cache/modules/gbiA4_Anexo4/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/gbiA4_Anexo4/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/gbiA4_Anexo4/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/gbiA4_Anexo4/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/gbiA4_Anexo4/SearchForm_advanced.tpl', 44, false),array('function', 'sugar_getimage', 'cache/modules/gbiA4_Anexo4/SearchForm_advanced.tpl', 87, false),array('function', 'html_options', 'cache/modules/gbiA4_Anexo4/SearchForm_advanced.tpl', 229, false),array('modifier', 'default', 'cache/modules/gbiA4_Anexo4/SearchForm_advanced.tpl', 244, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'gbiA4_Anexo4'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='gbian_anexo2_gbia4_anexo4_1_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_GBIAN_ANEXO2_GBIA4_ANEXO4_1_FROM_GBIAN_ANEXO2_TITLE','module' => 'gbiA4_Anexo4'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['gbian_anexo2_gbia4_anexo4_1_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['gbian_anexo2_gbia4_anexo4_1_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['gbian_anexo2_gbia4_anexo4_1_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['gbian_anexo2_gbia4_anexo4_1gbian_anexo2_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['gbian_anexo2_gbia4_anexo4_1gbian_anexo2_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['gbian_anexo2_gbia4_anexo4_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['gbian_anexo2_gbia4_anexo4_1_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"gbian_anexo2_gbia4_anexo4_1gbian_anexo2_ida_advanced","name":"gbian_anexo2_gbia4_anexo4_1_name_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['gbian_anexo2_gbia4_anexo4_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['gbian_anexo2_gbia4_anexo4_1_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['gbian_anexo2_gbia4_anexo4_1gbian_anexo2_ida_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='gbia4_anexo4_gbia3_anexo3_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_GBIA4_ANEXO4_GBIA3_ANEXO3_FROM_GBIA3_ANEXO3_TITLE','module' => 'gbiA4_Anexo4'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['gbia4_anexo4_gbia3_anexo3_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['gbia4_anexo4_gbia3_anexo3_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['gbia4_anexo4_gbia3_anexo3_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['gbia4_anexo4_gbia3_anexo3gbia3_anexo3_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['gbia4_anexo4_gbia3_anexo3gbia3_anexo3_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['gbia4_anexo4_gbia3_anexo3_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['gbia4_anexo4_gbia3_anexo3_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"gbia4_anexo4_gbia3_anexo3gbia3_anexo3_ida_advanced","name":"gbia4_anexo4_gbia3_anexo3_name_advanced"}}'; ?>
, "single", true);'><?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_SELECT'],'name' => "id-ff-select",'ext' => ".png",'other_attributes' => ''), $this);?>
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['gbia4_anexo4_gbia3_anexo3_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['gbia4_anexo4_gbia3_anexo3_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['gbia4_anexo4_gbia3_anexo3gbia3_anexo3_ida_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
</button>
</span>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='prestador_servicio_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRESTADOR_SERVICIO','module' => 'gbiA4_Anexo4'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['prestador_servicio_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['prestador_servicio_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['prestador_servicio_advanced']['value']; ?>
" title='' autocomplete="off"  >
...
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['prestador_servicio_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['prestador_servicio_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"ips_ips_id_c_advanced","name":"prestador_servicio_advanced"}}'; ?>
, "single", true);'><?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_SELECT'],'name' => "id-ff-select",'ext' => ".png",'other_attributes' => ''), $this);?>
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['prestador_servicio_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['prestador_servicio_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='nombquienautoriza_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NOMBQUIENAUTORIZA','module' => 'gbiA4_Anexo4'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['nombquienautoriza_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['nombquienautoriza_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['nombquienautoriza_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['nombquienautoriza_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['nombquienautoriza_c_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_entered_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'gbiA4_Anexo4'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='fecha_recibida_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FECHA_RECIBIDA','module' => 'gbiA4_Anexo4'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php $this->assign('id', $this->_tpl_vars['fields']['fecha_recibida_c_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['fecha_recibida_c_advanced_range_choice'] )):  $this->assign('starting_choice', $_REQUEST['fecha_recibida_c_advanced_range_choice']);  else:  $this->assign('starting_choice', "=");  endif; ?>
...
_range_choice" style="width:125px !important;" onchange="<?php echo $this->_tpl_vars['id']; ?>
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['fecha_recibida_c_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_fecha_recibida_c_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_fecha_recibida_c_advanced'] ) && ! empty ( $_REQUEST['fecha_recibida_c_advanced'] )):  echo $_REQUEST['fecha_recibida_c_advanced'];  else:  echo $_REQUEST['range_fecha_recibida_c_advanced'];  endif; ?>' title=''   size="11" style="width:100px !important;">
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>
...
<div id="<?php echo $this->_tpl_vars['id']; ?>
_between_range_div" style="<?php if ($this->_tpl_vars['starting_choice'] == 'between'): ?>display:'';<?php else: ?>display:none;<?php endif; ?>">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['fecha_recibida_c_advanced']['value']); ?>
<input autocomplete="off" type="text" name="start_range_<?php echo $this->_tpl_vars['id']; ?>
" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['start_range_fecha_recibida_c_advanced']; ?>
' title=''  tabindex='' size="11" style="width:100px !important;">
<?php ob_start(); ?>align="absmiddle" border="0" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'alt' => ($this->_tpl_vars['APP']).".LBL_ENTER_DATE other_attributes=".($this->_tpl_vars['other_attributes'])), $this);?>
...
<input autocomplete="off" type="text" name="end_range_<?php echo $this->_tpl_vars['id']; ?>
" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['end_range_fecha_recibida_c_advanced']; ?>
' title=''  tabindex='' size="11" style="width:100px !important;" maxlength="10">
<?php ob_start(); ?>align="absmiddle" border="0" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'alt' => ($this->_tpl_vars['APP']).".LBL_ENTER_DATE other_attributes=".($this->_tpl_vars['other_attributes'])), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='created_by_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'gbiA4_Anexo4'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
