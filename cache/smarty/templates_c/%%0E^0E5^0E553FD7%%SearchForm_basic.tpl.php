<?php /* Smarty version 2.6.11, created on 2022-07-05 19:54:19
         compiled from cache/modules/Accounts/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Accounts/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/Accounts/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/Accounts/SearchForm_basic.tpl', 43, false),array('function', 'sugar_getimage', 'cache/modules/Accounts/SearchForm_basic.tpl', 197, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/SearchForm_basic.tpl', 214, false),array('modifier', 'count', 'cache/modules/Accounts/SearchForm_basic.tpl', 201, false),)), $this); ?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='primernombre_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMERNOMBRE','module' => 'Accounts'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['primernombre_c_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['primernombre_c_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['primernombre_c_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['primernombre_c_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['primernombre_c_basic']['name']; ?>
' size='30' 
    maxlength='40' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='segundonombre_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SEGUNDONOMBRE','module' => 'Accounts'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['segundonombre_c_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['segundonombre_c_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['segundonombre_c_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['segundonombre_c_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['segundonombre_c_basic']['name']; ?>
' size='30' 
    maxlength='40' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='primerapellido_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMERAPELLIDO','module' => 'Accounts'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['primerapellido_c_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['primerapellido_c_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['primerapellido_c_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['primerapellido_c_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['primerapellido_c_basic']['name']; ?>
' size='30' 
    maxlength='40' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='segundoapellido_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SEGUNDOAPELLIDO','module' => 'Accounts'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['segundoapellido_c_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['segundoapellido_c_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['segundoapellido_c_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['segundoapellido_c_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['segundoapellido_c_basic']['name']; ?>
' size='30' 
    maxlength='40' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='epsactual_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EPSACTUAL','module' => 'Accounts'), $this);?>
</label>
    	</td>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['epsactual_c_basic']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['epsactual_c_basic']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['epsactual_c_basic']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['eps_eps_id_c_basic']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['eps_eps_id_c_basic']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['epsactual_c_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['epsactual_c_basic']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"eps_eps_id_c_basic","name":"epsactual_c_basic"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['epsactual_c_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['epsactual_c_basic']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['eps_eps_id_c_basic']['name']; ?>
