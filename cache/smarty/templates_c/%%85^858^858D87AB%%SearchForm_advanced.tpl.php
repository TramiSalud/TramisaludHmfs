...
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Accounts/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/Accounts/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Accounts/SearchForm_advanced.tpl', 44, false),array('function', 'html_options', 'cache/modules/Accounts/SearchForm_advanced.tpl', 228, false),array('function', 'sugar_getimage', 'cache/modules/Accounts/SearchForm_advanced.tpl', 287, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='primernombre_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMERNOMBRE','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['primernombre_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['primernombre_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['primernombre_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['primernombre_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['primernombre_c_advanced']['name']; ?>
' size='30' 
    maxlength='40' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='segundonombre_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SEGUNDONOMBRE','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['segundonombre_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['segundonombre_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['segundonombre_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['segundonombre_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['segundonombre_c_advanced']['name']; ?>
' size='30' 
    maxlength='40' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='primerapellido_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMERAPELLIDO','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['primerapellido_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['primerapellido_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['primerapellido_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['primerapellido_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['primerapellido_c_advanced']['name']; ?>
' size='30' 
    maxlength='40' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='segundoapellido_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SEGUNDOAPELLIDO','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['segundoapellido_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['segundoapellido_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['segundoapellido_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['segundoapellido_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['segundoapellido_c_advanced']['name']; ?>
' size='30' 
    maxlength='40' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='estado_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ESTADO','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'estado_c_advanced','name' => 'estado_c_advanced[]','options' => $this->_tpl_vars['fields']['estado_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['estado_c_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='tipocobertura_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TIPOCOBERTURA','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'tipocobertura_c_advanced','name' => 'tipocobertura_c_advanced[]','options' => $this->_tpl_vars['fields']['tipocobertura_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['tipocobertura_c_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='epsactual_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EPSACTUAL','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['epsactual_c_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['epsactual_c_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['epsactual_c_advanced']['value']; ?>
...
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['epsactual_c_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['epsactual_c_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"eps_eps_id_c_advanced","name":"epsactual_c_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['epsactual_c_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['epsactual_c_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='ipsactual_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_IPSACTUAL','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['ipsactual_c_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['ipsactual_c_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['ipsactual_c_advanced']['value']; ?>
" title='' autocomplete="off"  >
...
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['ipsactual_c_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['ipsactual_c_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"ips_ips_id_c_advanced","name":"ipsactual_c_advanced"}}'; ?>
, "single", true);'><?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_SELECT'],'name' => "id-ff-select",'ext' => ".png",'other_attributes' => ''), $this);?>
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['ipsactual_c_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['ipsactual_c_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='numeroformulario_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NUMEROFORMULARIO','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['numeroformulario_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['numeroformulario_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['numeroformulario_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['numeroformulario_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['numeroformulario_c_advanced']['name']; ?>
' size='30' 
    maxlength='10' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
