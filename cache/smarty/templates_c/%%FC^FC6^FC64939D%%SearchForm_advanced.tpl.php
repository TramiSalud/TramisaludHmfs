<?php /* Smarty version 2.6.11, created on 2022-07-06 22:13:21
         compiled from cache/modules/GBIA3_ANEXO3/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/GBIA3_ANEXO3/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/GBIA3_ANEXO3/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/GBIA3_ANEXO3/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/GBIA3_ANEXO3/SearchForm_advanced.tpl', 45, false),array('function', 'html_options', 'cache/modules/GBIA3_ANEXO3/SearchForm_advanced.tpl', 59, false),array('function', 'sugar_getimage', 'cache/modules/GBIA3_ANEXO3/SearchForm_advanced.tpl', 66, false),array('modifier', 'default', 'cache/modules/GBIA3_ANEXO3/SearchForm_advanced.tpl', 74, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_entered_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='accounts_gbia3_anexo3_1_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNTS_GBIA3_ANEXO3_1_FROM_ACCOUNTS_TITLE','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['accounts_gbia3_anexo3_1_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['accounts_gbia3_anexo3_1_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['accounts_gbia3_anexo3_1_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['accounts_gbia3_anexo3_1accounts_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['accounts_gbia3_anexo3_1accounts_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['accounts_gbia3_anexo3_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['accounts_gbia3_anexo3_1_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"accounts_gbia3_anexo3_1accounts_ida_advanced","name":"accounts_gbia3_anexo3_1_name_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['accounts_gbia3_anexo3_1_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['accounts_gbia3_anexo3_1_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['accounts_gbia3_anexo3_1accounts_ida_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='prestador_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRESTADOR','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['prestador_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['prestador_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['prestador_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['ips_ips_id_c_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['ips_ips_id_c_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['prestador_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['prestador_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"ips_ips_id_c_advanced","name":"prestador_advanced"}}'; ?>
, "single", true);'><?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_SELECT'],'name' => "id-ff-select",'ext' => ".png",'other_attributes' => ''), $this);?>
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['prestador_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['prestador_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['ips_ips_id_c_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
</button>
</span>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='eps_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EPS','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='prioridadatencion2_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIORIDADATENCION2','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'prioridadatencion2_advanced','name' => 'prioridadatencion2_advanced[]','options' => $this->_tpl_vars['fields']['prioridadatencion2_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['prioridadatencion2_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='origenatencion_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ORIGENATENCION','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'origenatencion_advanced','name' => 'origenatencion_advanced[]','options' => $this->_tpl_vars['fields']['origenatencion_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['origenatencion_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='ubicacion_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_UBICACION','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'ubicacion_advanced','name' => 'ubicacion_advanced[]','options' => $this->_tpl_vars['fields']['ubicacion_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['ubicacion_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='nombresolicitante_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NOMBRESOLICITANTE','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['nombresolicitante_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['nombresolicitante_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['nombresolicitante_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['nombresolicitante_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['nombresolicitante_advanced']['name']; ?>
' size='30' 
    maxlength='60' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='correo_enviado_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CORREO_ENVIADO','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='created_by_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='numero_reintentos_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NUMERO_REINTENTOS','module' => 'GBIA3_ANEXO3'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_accounts_gbia3_anexo3_1_name_advanced\']={"form":"search_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["search_form_accounts_gbia3_anexo3_1_name_advanced","accounts_gbia3_anexo3_1accounts_ida_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["accounts_gbia3_anexo3_1accounts_ida"],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_especialist_c_advanced\']={"form":"search_form","method":"query","modules":["ESP_Especialista"],"group":"or","field_list":["name","id","nombres","apellidos","cargo","telppal","extension","telcel"],"populate_list":["name_advanced","esp_especialista_id_c_advanced","nombresolicitante_advanced","apellidossolicitante_c_advanced","cargoactividadrelacion_advanced","telefonosolicitante_advanced","extensionsolicitante_c_advanced","celularsolicitante_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_especialista_c_advanced\']={"form":"search_form","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["especialista_c_advanced","contact_id_c_advanced","contact_id_c_advanced","contact_id_c_advanced"],"required_list":["contact_id_c"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_gestorexterno_c_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["gestorexterno_c_advanced","user_id2_c_advanced"],"required_list":["user_id2_c"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};</script>'; ?>