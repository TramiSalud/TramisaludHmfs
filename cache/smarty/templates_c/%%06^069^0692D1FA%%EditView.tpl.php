...
<?php ob_start(); ?>
<tr>
<td valign="top" id='grupo_del_usuario_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_GRUPO_DEL_USUARIO','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<select name="<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['grupo_del_usuario_c']['value'] ) && $this->_tpl_vars['fields']['grupo_del_usuario_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['grupo_del_usuario_c']['options'],'selected' => $this->_tpl_vars['fields']['grupo_del_usuario_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['grupo_del_usuario_c']['options'],'selected' => $this->_tpl_vars['fields']['grupo_del_usuario_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['grupo_del_usuario_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['grupo_del_usuario_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
addToValidate(\'EditView\', \'pwd_last_changed_date\', \'date\', false,\'contraseña cambiada por última vez\' );
...
addToValidate(\'EditView\', \'grupo_del_usuario_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_GRUPO_DEL_USUARIO','module' => 'Users','for_js' => true), $this); echo '\' );
...
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_reports_to_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name","reports_to_id"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};</script>'; ?>
