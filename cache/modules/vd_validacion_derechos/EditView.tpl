...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"vd_validacion_derechos_accountsaccounts_ida","name":"vd_validacion_derechos_accounts_name"}}{/literal}, 
"single", 
true
...
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'document_name', 'name', false,'{/literal}{sugar_translate label='LBL_NAME' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'filename', 'varchar', true,'{/literal}{sugar_translate label='LBL_FILENAME' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'file_ext', 'varchar', false,'{/literal}{sugar_translate label='LBL_FILE_EXTENSION' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'file_mime_type', 'varchar', false,'{/literal}{sugar_translate label='LBL_MIME' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'uploadfile', 'file', false,'{/literal}{sugar_translate label='LBL_FILE_UPLOAD' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'active_date', 'date', true,'{/literal}{sugar_translate label='LBL_DOC_ACTIVE_DATE' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'exp_date', 'date', false,'{/literal}{sugar_translate label='LBL_DOC_EXP_DATE' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'category_id', 'enum', true,'{/literal}{sugar_translate label='LBL_SF_CATEGORY' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'subcategory_id', 'enum', false,'{/literal}{sugar_translate label='LBL_SF_SUBCATEGORY' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'status_id', 'enum', false,'{/literal}{sugar_translate label='LBL_DOC_STATUS' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'status', 'varchar', false,'{/literal}{sugar_translate label='LBL_DOC_STATUS' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'tipo_consulta', 'enum', true,'{/literal}{sugar_translate label='LBL_TIPO_CONSULTA' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'institucion', 'enum', true,'{/literal}{sugar_translate label='LBL_INSTITUCION' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidate('EditView', 'vd_validacion_derechos_accounts_name', 'relate', false,'{/literal}{sugar_translate label='LBL_VD_VALIDACION_DERECHOS_ACCOUNTS_FROM_ACCOUNTS_TITLE' module='vd_validacion_derechos' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='vd_validacion_derechos' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='vd_validacion_derechos' for_js=true}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'vd_validacion_derechos_accounts_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='vd_validacion_derechos' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_VD_VALIDACION_DERECHOS_ACCOUNTS_FROM_ACCOUNTS_TITLE' module='vd_validacion_derechos' for_js=true}{literal}', 'vd_validacion_derechos_accountsaccounts_ida' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_vd_validacion_derechos_accounts_name']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["EditView_vd_validacion_derechos_accounts_name","vd_validacion_derechos_accountsaccounts_ida"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["vd_validacion_derechos_accountsaccounts_ida"],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};</script>{/literal}
