...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='GBIA3_ANEXO3'}</label>
    	</td>
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='GBIA3_ANEXO3'}</label>
		</td>
	<td  nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='accounts_gbia3_anexo3_1_name_advanced'>{sugar_translate label='LBL_ACCOUNTS_GBIA3_ANEXO3_1_FROM_ACCOUNTS_TITLE' module='GBIA3_ANEXO3'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="{$fields.accounts_gbia3_anexo3_1_name_advanced.name}"  class="sqsEnabled"   id="{$fields.accounts_gbia3_anexo3_1_name_advanced.name}" size="" value="{$fields.accounts_gbia3_anexo3_1_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.accounts_gbia3_anexo3_1accounts_ida_advanced.name}" value="{$fields.accounts_gbia3_anexo3_1accounts_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.accounts_gbia3_anexo3_1_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.accounts_gbia3_anexo3_1_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"accounts_gbia3_anexo3_1accounts_ida_advanced","name":"accounts_gbia3_anexo3_1_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.accounts_gbia3_anexo3_1_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.accounts_gbia3_anexo3_1_name_advanced.name}.value = ''; this.form.{$fields.accounts_gbia3_anexo3_1accounts_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='prestador_advanced'>{sugar_translate label='LBL_PRESTADOR' module='GBIA3_ANEXO3'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="{$fields.prestador_advanced.name}"  class="sqsEnabled"   id="{$fields.prestador_advanced.name}" size="" value="{$fields.prestador_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.ips_ips_id_c_advanced.name}" value="{$fields.ips_ips_id_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.prestador_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.prestador_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"ips_ips_id_c_advanced","name":"prestador_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.prestador_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.prestador_advanced.name}.value = ''; this.form.{$fields.ips_ips_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='eps_advanced'>{sugar_translate label='LBL_EPS' module='GBIA3_ANEXO3'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="{$fields.eps_advanced.name}"  class="sqsEnabled"   id="{$fields.eps_advanced.name}" size="" value="{$fields.eps_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.eps_eps_id_c_advanced.name}" value="{$fields.eps_eps_id_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.eps_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.eps_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"eps_eps_id_c_advanced","name":"eps_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.eps_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.eps_advanced.name}.value = ''; this.form.{$fields.eps_eps_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='prioridadatencion2_advanced'>{sugar_translate label='LBL_PRIORIDADATENCION2' module='GBIA3_ANEXO3'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='prioridadatencion2_advanced' name='prioridadatencion2_advanced[]' options=$fields.prioridadatencion2_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.prioridadatencion2_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='origenatencion_advanced'>{sugar_translate label='LBL_ORIGENATENCION' module='GBIA3_ANEXO3'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='origenatencion_advanced' name='origenatencion_advanced[]' options=$fields.origenatencion_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.origenatencion_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='ubicacion_advanced'>{sugar_translate label='LBL_UBICACION' module='GBIA3_ANEXO3'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='ubicacion_advanced' name='ubicacion_advanced[]' options=$fields.ubicacion_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.ubicacion_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='nombresolicitante_advanced'>{sugar_translate label='LBL_NOMBRESOLICITANTE' module='GBIA3_ANEXO3'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.nombresolicitante_advanced.value) <= 0}
{assign var="value" value=$fields.nombresolicitante_advanced.default_value }
{else}
{assign var="value" value=$fields.nombresolicitante_advanced.value }
{/if}  
<input type='text' name='{$fields.nombresolicitante_advanced.name}' 
    id='{$fields.nombresolicitante_advanced.name}' size='30' 
    maxlength='60' 
    value='{$value}' title=''      >
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='correo_enviado_c_advanced'>{sugar_translate label='LBL_CORREO_ENVIADO' module='GBIA3_ANEXO3'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.correo_enviado_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.correo_enviado_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.correo_enviado_c_advanced.name}" name="{$fields.correo_enviado_c_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='created_by_advanced'>{sugar_translate label='LBL_CREATED' module='GBIA3_ANEXO3'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{html_options name='created_by_advanced[]' options=$user_options size="6" style="width: 150px" multiple="1" selected=$fields.created_by_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='numero_reintentos_c_advanced'>{sugar_translate label='LBL_NUMERO_REINTENTOS' module='GBIA3_ANEXO3'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.numero_reintentos_c_advanced.value) <= 0}
{assign var="value" value=$fields.numero_reintentos_c_advanced.default_value }
{else}
{assign var="value" value=$fields.numero_reintentos_c_advanced.value }
{/if}  
<input type='text' name='{$fields.numero_reintentos_c_advanced.name}' 
    id='{$fields.numero_reintentos_c_advanced.name}' size='30' 
    maxlength='50' 
    value='{$value}' title=''      >
   	   	</td>
	</tr>
