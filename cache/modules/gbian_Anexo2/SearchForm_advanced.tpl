...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='gbian_Anexo2'}</label>
    	</td>
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='gbian_Anexo2'}</label>
		</td>
	<td  nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='eps_advanced'>{sugar_translate label='LBL_EPS' module='gbian_Anexo2'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<button type="button" name="btn_{$fields.eps_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.eps_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"eps_eps_id_c_advanced","name":"eps_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.eps_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.eps_advanced.name}.value = ''; this.form.{$fields.eps_eps_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='gbian_anexo2_accounts_name_advanced'>{sugar_translate label='LBL_GBIAN_ANEXO2_ACCOUNTS_FROM_ACCOUNTS_TITLE' module='gbian_Anexo2'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="{$fields.gbian_anexo2_accounts_name_advanced.name}"  class="sqsEnabled"   id="{$fields.gbian_anexo2_accounts_name_advanced.name}" size="" value="{$fields.gbian_anexo2_accounts_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.gbian_anexo2_accountsaccounts_ida_advanced.name}" value="{$fields.gbian_anexo2_accountsaccounts_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.gbian_anexo2_accounts_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.gbian_anexo2_accounts_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"gbian_anexo2_accountsaccounts_ida_advanced","name":"gbian_anexo2_accounts_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.gbian_anexo2_accounts_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.gbian_anexo2_accounts_name_advanced.name}.value = ''; this.form.{$fields.gbian_anexo2_accountsaccounts_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='correo_enviado_c_advanced'>{sugar_translate label='LBL_CORREO_ENVIADO' module='gbian_Anexo2'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<select id="{$fields.correo_enviado_c_advanced.name}" name="{$fields.correo_enviado_c_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='created_by_advanced'>{sugar_translate label='LBL_CREATED' module='gbian_Anexo2'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{html_options name='created_by_advanced[]' options=$user_options size="6" style="width: 150px" multiple="1" selected=$fields.created_by_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='numero_reintentos_c_advanced'>{sugar_translate label='LBL_NUMERO_REINTENTOS' module='gbian_Anexo2'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
