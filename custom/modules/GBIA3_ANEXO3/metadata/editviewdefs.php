      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'customCode' => '<input name="primernombre_c" id="primernombre_c" size="30" maxlength="100" 
		      	type="text" value="{$fields.primernombre_c.value}" OnFocus="this.blur()">',
          ),
          1 => 
          array (
            'name' => 'segundonombre_c',
            'label' => 'LBL_SEGUNDONOMBRE',
            'customCode' => '<input name="segundonombre_c" id="segundonombre_c" size="30" maxlength="100" 
			type="text" value="{$fields.segundonombre_c.value}" OnFocus="this.blur()">',
          ),
        ),
        2 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input name="primerapellido_c" id="primerapellido_c" size="30" maxlength="100" 
			type="text" value="{$fields.primerapellido_c.value}" OnFocus="this.blur()">',
          ),
          1 => 
          array (
            'name' => 'segundoapellido_c',
            'label' => 'LBL_SEGUNDOAPELLIDO',
            'customCode' => '<input name="segundoapellido_c" id="segundoapellido_c" size="30" maxlength="100" 
			type="text" value="{$fields.segundoapellido_c.value}" OnFocus="this.blur()">',
          ),
        ),
        3 => 
        array (
