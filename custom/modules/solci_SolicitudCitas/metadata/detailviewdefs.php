    ...
    array (
      ...
      array (
        ...
        array (
          ...
          4 => 
          array (
            'customCode' => '<input title="GenerarPDF" type="submit" name="button" value="Generar PDF" onClick="window.open(\'index.php?module=solci_SolicitudCitas&action=sugarpdf&record={$fields.id.value}&sugarpdf=pdf\');">',
            'name' => 'GenerarPDF',
            'label' => 'Generar PDF',
          ),
        ),
