<?php
	...
	$dptorespo= BeanFactory::getBean("DEP_Departamentos",$anexo_9->dep_departamentos_id_c);
	...
	*/
	...
	$pdf->SetXY(20,263.2);
	$pdf->Cell(0,10, utf8_decode($especialista->nombres)." ".utf8_decode($especialista->apellidos)." - ".utf8_decode($app_list_strings["cargactirela_c_anexo3"][$especialista->cargo]),0,0,'L');
