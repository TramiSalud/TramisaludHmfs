<?php
	...
	$historial = $this->bean->get_linked_beans('gbi_anexo3npos_gbihi_historialcorreo_1', 'GBIHI_HistorialCorreo');
	...
	$pdf->Output("TRAZABILIDAD - AT3 NO POS - ".$anexo_3->name.".pdf",'I');	
?>