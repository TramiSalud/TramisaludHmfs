...
$dictionary["gbia3_anexo3_accounts"] = array (
  ...
  array (
    ...
    array (
      ...
      'lhs_table' => 'accounts',
      'lhs_key' => 'id',
      'rhs_module' => 'GBIA3_anexo_3_no_pos',
      'rhs_table' => 'gbia3_anexo_3_no_pos',
      'rhs_key' => 'id',
      'relationship_type' => 'many-to-many',
      'join_table' => 'gbia3_anexo3_accounts_c',
      'join_key_lhs' => 'gbia3_anexo3_accountsaccounts_ida',
      'join_key_rhs' => 'gbia3_anexo3_accountsgbia3_anexo_3_no_pos_idb',
    ),
  ),
  ...
  array (
    ...
    4 => 
    array (
      'name' => 'gbia3_anexo3_accountsgbia3_anexo_3_no_pos_idb',
      'type' => 'varchar',
      'len' => 36,
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'fields' => 
      array (
        0 => 'gbia3_anexo3_accountsgbia3_anexo_3_no_pos_idb',
      ),
    ),
  ),
);