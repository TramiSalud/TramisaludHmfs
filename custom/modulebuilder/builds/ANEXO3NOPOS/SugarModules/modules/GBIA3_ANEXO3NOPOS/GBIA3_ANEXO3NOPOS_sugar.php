 ...
 * PLACE ANY CUSTOMIZATIONS IN GBIA3_ANEXO3NOPOS
 */


class GBIA3_ANEXO3NOPOS_sugar extends Basic {
	var $new_schema = true;
	var $module_dir = 'GBIA3_ANEXO3NOPOS';
	var $object_name = 'GBIA3_ANEXO3NOPOS';
	var $table_name = 'gbia3_anexo3nopos';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $especialist;
		var $cargo_acti;
		function GBIA3_ANEXO3NOPOS_sugar(){	
		parent::Basic();
	}
