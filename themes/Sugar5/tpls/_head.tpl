...
<!--se agregan librerias de notificaciones-->
    <link href='{sugar_getjspath file="themes/Sugar5/css/pnotify.custom.min.css"}' media="all" rel="stylesheet" type="text/css">
    <script type="text/javascript" src='{sugar_getjspath file="themes/Sugar5/js/pnotify.custom.min.js"}'></script>
    <script type="text/javascript" src='{sugar_getjspath file="themes/Sugar5/js/notify.js"}'></script>
</head>