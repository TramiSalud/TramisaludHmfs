...
class ViewCie10a3 extends SugarView {

    function ViewCie10a3() {
        parent::SugarView();
    }
    ...
    function display() {
        ...
        if (!empty($_REQUEST['export_trigger'])) {
            ...
            $field_headings = array('DIAGNOSTICO PRINCIPAL MAS COMUN ANEXO 3', 'DESCRIPCION PRINCIPAL', 'CANTIDAD');
            ...
            $query = "SELECT
            diag.name as 'DIAGNOSTICO PRINCIPAL MAS COMUN ANEXO 3',
        ...
        FROM
            ...
            $query .= "group by a3.cie_cie10_id_c  having count(cie_cie10_id_c) > 1 order by count(cie_cie10_id_c) desc limit 5";
            ...
            $filename = 'DIAGNOSTICO_CIE10_A3_MASCOMUNES_'.date("dmY").".csv";
        ...
        else
        {
            ...
            ?>
            <h1>Reporte - Diagnóticos CIE 10 más comunes Anexo 3</h1>
                    ...
                    <tr>
                        <td class="tabForm">
                            ...
                            <form id="reportfm" name="reportfm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" onsubmit="return validateForm()">
                                ...
                                <input type="hidden" name="action" value="cie10a3" />
                                </br>&nbsp;
