...
WHERE gbia4_anexo4.deleted=0 ";
			if (!empty($_REQUEST["eps_id_c"])){
				$query .= "AND accounts_cstm.eps_eps_id_c = '". $_REQUEST["eps_id_c"]."' ";
			}
			if (!empty($_REQUEST["tipours"]) && ($_REQUEST['tipousr'] != "0") ) {
				$query .= "AND gbia4_anexo4_cstm.tipo_usuario_c ='" .$REQUEST["tipousr"]."' ";
			}
		...
		else
		{
			...
			<h1>EXPORTACION GESTION ANEXO4</h1>
					...
					<tr>
						<td class="tabForm">
							<form name=reportfm action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
								...
								<input autocomplete="off" name="fecha_inicio" id="fecha_inicio" value="" title="" tabindex="1" size="11" maxlength="10" type="text"> <img src="themes/default/images/jscalendar.gif" alt="Start Date" id="start_date_trigger" align="absmiddle" border="0">
								<script type="text/javascript">
								Calendar.setup({
								...
								<br>			
								<strong>Fecha Final:&nbsp;&nbsp;</strong> <input autocomplete="off" name="fecha_final" id="fecha_final" value="" title="" tabindex="1" size="11" maxlength="10" type="text"> <img src="themes/default/images/jscalendar.gif" alt="End Date" id="end_date_trigger" align="absmiddle" border="0">
								<script type="text/javascript">
								    Calendar.setup ({
