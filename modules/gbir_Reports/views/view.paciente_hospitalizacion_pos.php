...
class ViewPaciente_Hospitalizacion_Pos extends SugarView {

	function ViewPaciente_Hospitalizacion_Pos() {
 		parent::SugarView();
	}
...
?>
<h1>INFORME SEGUIMIENTO PACIENTE HOSPITALIZACION POS</h1>
			...
			<td class="tabForm">
				...
				<form name=reportfm action="<?php echo $_SERVER['PHP_SELF']; ?>"
					...
					<input type="hidden" name="module"
						...
						name="action" value="paciente_hospitalizacion_pos" /> <strong>Consultas:</strong> <br /><br />
...
<table border="0" cellpadding="2" cellspacing="3" width="730" class="h3Row">
	<tr>
		<td align="left" valign="top" colspan="2">
			...
			<h3 style="margin: 0px;">Informe Seguimiento Paciente Hospitalización Pos </h3>
...
CONCAT(
	...
	users.last_name
					...
					AND a3.ubicacion = 'hospitalizacion' ";
...
<?
	...
	if ($_REQUEST['submit'] == 'Generar Reporte Excel'){
			...
			$xls->generateXML('Informe_Seguimiento_Paciente_Hospitalizacion_POS');
