...
<?
class basa1_ANEXO1ViewEdit extends ViewEdit { 
    var $ev; 
    var $type ='edit'; 
    ...
    function display(){ 
		...
		$this->ev->fieldDefs['correo_pagador_c']['value'] = $pagador->emailanexo1;
		...
		if (isset($_REQUEST['return_id']))
		{
			...
			$anexo1->retrieve($_REQUEST['return_id']);
