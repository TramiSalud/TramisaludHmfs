...
$app_list_strings = array ( 
  ...
  //e.g. en español 'Apparel'=>'Ropa',
   ...
   'wflow_fire_order_dom' => array (
    'alerts_actions'=>'Alertas antes que Acciones',
...
$app_strings = array ( 
    ...
    'LBL_EMAIL_OPT_OUT_AND_INVALID'         => 'No v�lido' ,
    ...
    'LBL_INVALID_FILE_EXTENSION' => 'Extensi�n de archivo incorrecto' ,
    ...
    'ERR_AJAX_LOAD_FAILURE' => 'Hubo un error al procesar su solicitud, por favor, int�ntelo de nuevo m�s tarde.' ,
    'ERR_AJAX_LOAD_FOOTER' => 'Si el error persiste, por favor, pida al administrador desactivar Ajax para este m�dulo.' ,    
    ...
    'ERR_EXTERNAL_API_UPLOAD_FAIL' => 'Se produjo un error durante la carga. Por favor, asegurar que el archivo que est� cargando no est� vac�o.' ,    
   ...
   'LBL_NO_MASS_UPDATE_FIELDS_AVAILABLE' => 'No hay campos disponibles para la operaci�n de actualizaci�n de la Masiva' ,    
    ...
    'LBL_ACCESSKEY_CLEAR_RELATE_TITLE' => 'Borrar selecci�n' ,
    'LBL_ACCESSKEY_CLEAR_RELATE_LABEL' => 'Borrar selecci�n' ,
    'LBL_ACCESSKEY_CLEAR_COLLECTION_TITLE' => 'Borrar selecci�n' ,
    'LBL_ACCESSKEY_CLEAR_COLLECTION_LABEL' => 'Borrar selecci�n' ,
    ...
    'LBL_ACCESSKEY_SELECT_CAMPAIGNS_TITLE' => 'Seleccione la campa�a [Alt+M]' ,
    'LBL_ACCESSKEY_SELECT_CAMPAIGNS_LABEL' => 'Seleccione la campa�a' ,
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_TITLE' => 'Borrar campa�a' ,
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_LABEL' => 'Borrar campa�a' ,
   ...
   'MSG_JS_ALERT_MTG_REMINDER_CALL_MSG' => '\nHaga clic en Aceptar para ver esta llamada o Cancelar para cerrar este mensaje.' ,
   'MSG_JS_ALERT_MTG_REMINDER_MEETING_MSG' => '\nHaga clic en Aceptar para ver esta reunión o Cancelar para cerrar este mensaje' ,
    ...
    'LBL_PLUGIN_LOTUS_DESC' => 'Integrar Sugar con Lotus Notes.' ,    
   ...
   'LBL_ENTER_YEAR' => 'Introduzca A�o' ,
   'LBL_ENTER_VALID_YEAR' => 'Por favor, introduzca un a�o v�lido' ,
   'LBL_INVALID_USA_PHONE_FORMAT' => 'Por favor, introduzca un valor num�rico el n�mero de tel�fono de Mexico., incluyendo c�digo de �rea' ,
   'ERR_FILE_WRITE' => 'Error: No se pudo escribir el archivo {0}. Por favor, revise el sistema y los permisos del servidor web.' ,
   'ERR_FILE_NOT_FOUND' => 'Error: No se puede cargar el archivo {0}. Por favor, revise el sistema y los permisos del servidor web.' ,
   'LBL_AND' => 'Y' ,
   'LBL_BEFORE' => 'Antes de' ,
   'LBL_UPLOAD_FROM_COMPUTER' => 'Subir desde tu computadora' ,
   'LBL_SEARCH_EXTERNAL_API' => 'FArchivo de fuente externa' ,
   'LBL_EXTERNAL_SECURITY_LEVEL' => 'Seguridad' ,
   'LBL_SHARE_PRIVATE' => 'Privado' ,
   'LBL_SHARE_COMPANY' => 'Empresa' ,
   'LBL_SHARE_LINKABLE' => 'Se puede conectar' ,
   'LBL_SHARE_PUBLIC' => 'Publico' ,
   'LBL_RSS_FEED' => 'RSS Feed' ,
   'LBL_RSS_RECORDS_FOUND' => 'Registro (s) encontrado' ,
   'ERR_RSS_INVALID_INPUT' => 'RSS no es un tipo v�lido de entrada' ,
   'ERR_RSS_INVALID_RESPONSE' => 'RSS no es un tipo de respuesta v�lida para este m�todo' ,
   'ERR_GOOGLE_API_415' => 'Google Docs no es compatible con el formato de archivo que ha facilitado.' ,
   'LBL_IMPORT_SAMPLE_FILE_TEXT' => '
"Se trata de un archivo de importaci�n muestra que es un ejemplo de los contenidos previstos de un archivo que est� listo para la importaci�n."
"El archivo es un archivo delimitado por comas. Csv, usando comillas dobles, como el calificador de campo."
"La fila de encabezado es la fila de arriba-la mayor�a en el archivo que contiene las etiquetas de los campos a medida que los ver�a en la aplicaci�n."
"Estas etiquetas se utilizan para el mapeo de los datos en el archivo a los campos de la aplicaci�n."
"Notas: Los nombres de base de datos tambi�n podr�a ser utilizado en la fila de encabezado. Esto es �til cuando usted est� usando phpMyAdmin o cualquier otra herramienta de base de datos para proporcionar una lista de exportaci�n de datos a importar."
"El orden de las columnas no es cr�tico como el proceso de importaci�n coincide con el de datos a los campos apropiados basados ??en la fila de encabezado."
"Para utilizar este archivo como plantilla, haga lo siguiente:"
"1. Eliminar las filas de la muestra de los datos"
"2. Eliminar el texto de ayuda que est� leyendo en este momento"
"3. Entrada de sus propios datos en las filas y columnas apropiadas"
"4. Guarde el archivo en una ubicaci�n conocida de su sistema"
"5. Haga clic en la opci�n Importar en el men� Acciones en la aplicaci�n y seleccionar el archivo a subir"
   ' ,
   'LBL_EXPORT_ASSIGNED_USER_ID' => 'Asingnado A' ,
   'LBL_EXPORT_ASSIGNED_USER_NAME' => 'Usuario Asignado' ,
   'LBL_EXPORT_REPORTS_TO_ID' => 'Reporta a ID' ,
   'LBL_EXPORT_FULL_NAME' => 'Nombre Completo' ,
   'LBL_EXPORT_TEAM_ID' => 'Equipo' ,
   'LBL_EXPORT_TEAM_NAME' => 'Equipos' ,
   'LBL_QUICKEDIT_NODEFS_NAVIGATION' => 'Navegando...' ,
   'LBL_CREATE_KB_DOCUMENT' => 'Crear art�culo' ,
   'LBL_EMAIL_CHECK_INTERVAL_DOM' => array (
        ...
        '30' => 'Cada 30 minutos',
        '60' => 'Cada hora'  ));
$app_strings['LBL_EMAIL_ADDRESS_BOOK_TITLE_ICON'] = '<img src='.SugarThemeRegistry::current()->getImageURL('icon_email_addressbook.gif').' align=absmiddle border=0> Libreta de Direcciones';
$app_strings['LBL_EMAIL_ADDRESS_BOOK_TITLE_ICON_SHORT']  = '<img src='.SugarThemeRegistry::current()->getImageURL('icon_email_addressbook.gif').' align=absmiddle border=0>';

$app_strings['LBL_EMAIL_FOLDERS'] = '<img src='.SugarThemeRegistry::current()->getImageURL('icon_email_folder.gif').' align=absmiddle border=0> Carpetas';
$app_strings['LBL_EMAIL_FOLDERS_SHORT'] = '<img src='.SugarThemeRegistry::current()->getImageURL('icon_email_folder.gif').' align=absmiddle border=0>';

$app_strings['LBL_EMAIL_SEARCH'] = '<img src='.SugarThemeRegistry::current()->getImageURL('Search.gif').' align=absmiddle border=0> Búsqueda';
$app_strings['LBL_EMAIL_SEARCH_SHORT'] = '<img src='.SugarThemeRegistry::current()->getImageURL('Search.gif').' align=absmiddle border=0>';
?>
